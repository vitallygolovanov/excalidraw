...
export type HostPinchGestureResult = "ignored" | "started" | "applied" | "reset";
...
export interface ExcalidrawProps {
    ...
    handleFileUpload?: (file: File) => MaybePromise<{
        fileId: string;
        dataURL: string;
        mimeType: string;
    }>;
    resolveFileUrl?: (fileId: FileId) => MaybePromise<BinaryFileData | null | undefined>;
     ...
     */
    shouldSuppressDrop?: (sceneX: number, sceneY: number, event: React.DragEvent<HTMLDivElement>, file: File | null, fileHandle: FileSystemHandle | null) => boolean;
}
...
export type FrameNameBoundsCache = {
    get: (frameElement: ExcalidrawFrameTitleElement) => FrameNameBounds | null;
