import type { AppClassProperties, DataURL, BinaryFiles, AppProps, FileEventResolver, EventResolver, BinaryFileData } from "@excalidraw/excalidraw/types";
import type { ExcalidrawElement, FileId, InitializedExcalidrawImageElement } from "./types";
export declare const loadHTMLImageElement: (dataURL: DataURL, onError?: EventResolver) => Promise<HTMLImageElement>;
/** NOTE: updates cache even if already populated with given image. Thus,
 * you should filter out the images upstream if you want to optimize this. */
export declare const updateImageCache: ({ fileIds, files, imageCache, resolveFileUrl, onFileUrlError, }: {
    fileIds: FileId[];
    files: BinaryFiles;
    imageCache: AppClassProperties["imageCache"];
    resolveFileUrl?: AppProps["resolveFileUrl"];
    onFileUrlError?: FileEventResolver | undefined;
}) => Promise<{
    ...
    resolvedFiles: Map<FileId, BinaryFileData>;
}>;
